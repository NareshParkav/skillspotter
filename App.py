...
connection = pymysql.connect(host='localhost', user='root', password='bala@2001')
...
def run():
    ...
    if choice == 'Normal User':
        ...
        if st.button('Login'):
            if ad_user == 'CodeFellas' and ad_password == 'admin':
                st.success("Welcome CodeFellas")
                # Display Data
